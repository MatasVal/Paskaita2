namespace E002_SuperSkaiciuotuvas_TaikymasTestams
{
    /* ## Super Skaiciuotuvas ## 
    ...
    public class Program
    {
        ...
        public static List<double> testVals = new List<double>();
        ...
        {
            testVals.Add(Convert.ToDouble(ivedimas));
        }
        ...
        {
            return Convert.ToDouble(testVals[i++]);
        }
