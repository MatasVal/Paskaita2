...
namespace P011_Methods_Tests
{
    ...
    public class P015_Skaiciuotuvas_Tests
    {
        ...
        {
            var expected = 10 * 10;
            var actual = P014_Debug.Program.Skaiciuotuvas("10", "10", "^2");
        ...
        public void Skaiciuotuvas_Test1()
        {
            ...
            var actual = P014_Debug.Program.Skaiciuotuvas("10,1", "10", "^2");
        ...
        {
            var expected = 10.1 * 10.1;
            var actual = P014_Debug.Program.Skaiciuotuvas("10,1", "10", "5");
        ...
        {
            var expected = 10.1 + 10;
            var actual = P014_Debug.Program.Skaiciuotuvas("10,1", "10", "+");
